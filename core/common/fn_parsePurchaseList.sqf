...
_strategyArr pushBack ["RespawnBag", 20, [], "Purchase Fast Travel Tent", "\A3\Data_F_Warlords\Data\preview_ft_conflict.jpg", "Buy a deployable sleeping bag that respawns you at its location."];
