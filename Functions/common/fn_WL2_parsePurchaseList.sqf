...
_strategyArr pushBack ["RespawnBag", 20, [], "Purchase Sleeping Bag", "\A3\Data_F_Warlords\Data\preview_ft_conflict.jpg", "Buy a deployable sleeping bag that respawns you at its location."];
_strategyArr pushBack ["RespawnBagFT", 0, [], "Fast Travel to Sleeping Bag (Free)", "\A3\Data_F_Warlords\Data\preview_ft_conflict.jpg", ""];
